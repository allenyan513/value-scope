// ============================================================
// Legacy FCFF DCF Models (deprecated — kept for potential future use)
// ============================================================
...
import { avg, clamp, projectRevenue, type RevenueProjection } from "./dcf-helpers";
...
export interface DCFInputs {
  ...
  estimates: import("@/types").AnalystEstimate[];
