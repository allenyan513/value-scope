...
export const ARCHETYPE_CONFIGS: Record<CompanyArchetype, {
  ...
  mature_stable: {
    ...
    weights: {
      dcf_3stage: 0.15,
      dcf_fcff_ebitda_exit_5y: 0.10,
      dcf_fcff_ebitda_exit_10y: 0.10,
      pe_multiples: 0.40,
  ...
  cyclical: {
    ...
    weights: {
      dcf_3stage: 0.15,
      dcf_fcff_ebitda_exit_5y: 0.07,
      dcf_fcff_ebitda_exit_10y: 0.08,
      pe_multiples: 0.10,
  ...
  turnaround: {
    ...
    weights: {
      dcf_3stage: 0.15,
      dcf_fcff_ebitda_exit_5y: 0.05,
      dcf_fcff_ebitda_exit_10y: 0.05,
      pe_multiples: 0.00,
      ev_ebitda_multiples: 0.40,
      peg: 0.35,
    },
